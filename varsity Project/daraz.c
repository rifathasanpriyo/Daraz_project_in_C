...
void cart()
{
    ...
    else if (ch1 == '-')
    {
        ...
        if (itemToRemove > 0 && itemToRemove <= itemCount)
        {
    ...
    else
    {
        ...
        else if (ch2 == '2')
        {
            ...
            while (num != 'c')
            {
                   system("cls");
                Pages();
              printf("\n\t\t\033[0;36m1.iPhone 13 cover     ---> 615 tk\033[0m\n");
            printf("\t\t\033[0;36m2.Realme c12 cover   ---> 310 tk\033[0m\n");
            printf("\n\n\nAdd to cart--> ");
            scanf(" %c", &num);
            if (num == '1')
            {
                strcpy(items[itemCount], "iPhone 13 cover");
                prices[itemCount] = 615;
                itemCount++;
            }
            else if (num == '2')
            {
                strcpy(items[itemCount], "Realme c12 cover");
                prices[itemCount] = 310;
                itemCount++;
            }
            }
            choice(num);
    ...
    else if (ch2 == '3')
        {
            ...
            while (num != 'c')
            {
                   system("cls");
                Pages();
              printf("\n\t\t\033[0;36m1.Havit PB92     ---> 2203 tk\033[0m\n");
            printf("\t\t\033[0;36m2.Remix PPN   ---> 1999 tk\033[0m\n");
            printf("\n\n\nAdd to cart--> ");
            scanf(" %c", &num);
            if (num == '1')
            {
                strcpy(items[itemCount], "Havit PB92");
                prices[itemCount] = 2203;
                itemCount++;
            }
            else if (num == '2')
            {
                strcpy(items[itemCount], "Remix PPN");
                prices[itemCount] = 1999;
                itemCount++;
            }
            }
            choice(num);
...
void address()
{
    ...
    {
        system("cls");
        int number_bkash,pin;
        printf("\n\n\n Enter Your Bkash Number: ");
        scanf("%d",&number_bkash);
        printf("\n Enter Your Bkash Pin: ");
        scanf("%d",&pin);

        printf("\n\t\t \033[0;32myour order placed successfully\033[0\n");
        char b;
        scanf("%c",&b);
        dashboard();
